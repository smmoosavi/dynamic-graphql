...
mod node {
    ...
    use dynamic_graphql::{Context, GetSchemaData, Instance};
...
mod foo {
    ...
    use dynamic_graphql::{Instance, Object, Register, Registry};
    ...
    impl Register for RegisterFooNode {
        fn register(mut registry: Registry) -> Registry {
            ...
            node_data.insert(<FooNode as Object>::NAME.to_string(), |id| {
