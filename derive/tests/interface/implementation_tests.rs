...
#[test]
fn test_schema_simple_object_with_trait() {
    #[Interface(NodeInterface)]
    trait Node {
        fn the_id(&self) -> &String;
    }
...
#[test]
fn test_schema_resolved_object_with_trait() {
    #[Interface(NodeInterface)]
    trait Node {
        fn the_id(&self) -> String;
    }
...
#[test]
fn test_schema_expand_object_with_trait() {
    #[Interface(NodeInterface)]
    trait Node {
        fn the_id(&self) -> String;
    }
...
#[test]
fn test_schema_generic_expand_object_with_trait() {
    trait GetName {
        fn get_id(&self) -> String;
        fn get_name(&self) -> String;
    }
